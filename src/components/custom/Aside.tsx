        ...
        <div className="min-h-screen rounded-xl px-4 pt-5 bg-linear-to-b from-[#232323] to-[#0b0b0b]">
            ...
            <div className="sticky left-0 top-25">
                ...
                <div className={
                    ...
                    open ? "flex items-center gap-50" : "flex flex-col items-center"

                }>

                    <div onClick={() => openSideBar()} className="cursor-pointer p-1.5">

                        {/* <TbLayoutSidebarLeftExpand size={30} color="white" /> */}

                        {

                            open ? <TbLayoutSidebarRightExpand size={30} color="white" /> : <TbLayoutSidebarLeftExpand size={30} color="white" />
                    ...
                    <div className={
                        ...
                        open ? "rounded-full p-1.5 flex bg-[#353535] items-center justify-center" : "mt-2 rounded-full p-1.5 flex bg-[#353535] items-center justify-center"
